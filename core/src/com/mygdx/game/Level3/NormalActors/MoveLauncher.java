...
//        System.out.println(direction.x);
    ...
    public void launch(){
        ...
        CreateBullet createBullet1 = new CreateBullet((position1.x)*50,(position1.y)*50,launchDirection,ActConstants.windBulletID,1,1);
        CreateBullet createBullet2 = new CreateBullet((position2.x)*50,(position2.y)*50,launchDirection,ActConstants.windBulletID,1,1);
        CreateBullet createBullet3 = new CreateBullet((position3.x)*50,(position3.y)*50,launchDirection,ActConstants.windBulletID,1,1);
        CreateBullet createBullet4 = new CreateBullet((position4.x)*50,(position4.y)*50,launchDirection,ActConstants.windBulletID,1,1);
        CreateBullet createBullet5 = new CreateBullet((position5.x)*50,(position5.y)*50,launchDirection,ActConstants.windBulletID,1,1);
        CreateBullet createBullet6 = new CreateBullet((position6.x)*50,(position6.y)*50,launchDirection,ActConstants.windBulletID,1,1);
        CreateBullet createBullet7 = new CreateBullet((position7.x)*50,(position7.y)*50,launchDirection,ActConstants.windBulletID,1,1);
