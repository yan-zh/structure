...
public class AssetsLevel0 implements Disposable, AssetErrorListener {
    ...
    public void init(AssetManager assetManager) {
        ...
        // 测试类
        fonts = new AssetFonts();
        bunny = new AssetBunny(atlas_level0);
        rock = new AssetRock(atlas_level0);
        goldCoin = new AssetGoldCoin(atlas_level0);
        feather = new AssetFeather(atlas_level0);
        levelDecoration = new AssetLevelDecoration(atlas);
        sounds = new AssetSounds(assetManager);
        music = new AssetMusic(assetManager);

        // 主角类
        mainCharacter = new AssetMainCharacter(atlas_level0);
        characrer01 = new AssetCharacter01(atlas_level0);
        characrer02 = new AssetCharacter02(atlas_level0);
        fijling = new AssetFijling(atlas_level0);
        cdboss = new AssetCdboss(atlas_level0);
        assetBall = new AssetBall(atlas_level0);
        zj = new AssetZj(atlas_level0);
        srh = new AssetSrh(atlas_level0);
        jiemi = new AssetJiemi(atlas_level0);
        qingwa = new AssetQingwa(atlas_level0);
    }
